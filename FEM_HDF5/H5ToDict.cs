...
namespace Nastranh5
{
    public class H5ToDict
    {
        ...
        public Dictionary<string, dynamic> importH5files(Excel.Range Rng, string[] FileList, string MapFileName)
        {
            Dictionary<string, dynamic> ElemDict = new Dictionary<string, dynamic>();
